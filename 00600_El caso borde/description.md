Muchas veces cuando usamos un `repeat` nos encontramos con que el último caso es levemente distinto a los anteriores, llamaremos a esto **caso borde**. Pero mejor, veamos un ejemplo.
